...
export const KanbanColumn = (
  ...
  return (
    <SortableContext
      items={columnContent.containedItems}
      id={columnContent.id}
      strategy={verticalListSortingStrategy}
    >
      <div ref={setNodeRef} className="border-2 border-zinc-500 m-4 p-4 min-h-[28rem] min-w-[24rem] max-w-full bg-gray-900 no-scrollbar">
